...
import { updateBed } from "./db";
import { Toast } from "react-native-toast-message/lib/src/Toast";

const EditBed = ({ toggleThis, done, bed, onEdit }) => {
  ...
  const showToast = () => {
    Toast.show({
      type: "success",
      text1: "Success!",
      text2: "Bed Detail Updated Successfully.",
      position: "top"
    });
  };
      ...
      <View style={styles.container}>
        <TouchableWithoutFeedback>
          <View style={styles.main}>
            ...
            <Text style={styles.label}>Edit Bed Details</Text>
